document.addEventListener("DOMContentLoaded", function () {
    const form = document.getElementById("odrersite-form");
    const usernameInput = document.getElementById("username");
    const phoneInput = document.getElementById("forgot-password-phone"); 
    const submitButton = document.querySelector(".btnsendinordersitepage");
    ...
    form.addEventListener("submit", function (event) {
        ...
        xhr.open("POST", "http://localhost/HYPERION/php/ordersitepage.php", true);
